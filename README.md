...
- **📊 TanStack Table** - A headless UI for building tables and datagrids
- **🖱️ DND Kit** - A modern drag-and-drop toolkit for React
...
- **🎨 Beautiful UI** - A complete shadcn/ui component library with advanced interactions
...
- **API Client**: HTTP requests with Axios and TanStack Query
